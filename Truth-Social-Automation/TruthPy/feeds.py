...
class Feed:
    ...
    async def get_feed(self):
        ...
        # print(json.dumps(response['feed'],indent = 1))
    ...
    async def post_array(self, posts):
        post_array = []
        for post in posts:
            post_array.append(Post(post['id'], post['created_at'], post['in_reply_to_id'], post['url'], post['replies_count'], post['favourites_count'], post['content'],post['account']))
        return post_array
